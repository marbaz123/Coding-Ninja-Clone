     ...
     <div className=' bg-[#F6FBFB] relative  p-0 sm:p-10 md:p-20'>
        <div className=' w-full  flex flex-col '>
            ...
            <div className='md:flex sm:flex md:px-44 sm:p-5 p-2 md:py-16 '>
                ...
                <div className='bg-[#F6FBFB] flex flex-col justify-center items-center md:w-[56%] sm:w-[70%] w-full'>
                  <img src={Learn} alt="" 
                  className={`${ active === "learn" ? "flex" : "hidden"}`} 
                  />
                  <img src={Excel} alt="" 
                  className={`${ active === "excel" ? "flex" : "hidden"}`}
                   />
                  <img src={Standout} alt="" 
                  className={`${ active === "standout" ? "flex" : "hidden"}`}
                   />
                </div>
            </div>
        </div>
